          ...
          <ul class="dropdown-menu" role="menu">
            ...
            <li class="dropdown-submenu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="<?php echo site_url("admin/servicessadd"); ?>"><span class="glyphicon glyphicon-plus-sign"></span> Add Services</a></li>
                </ul>
            </li>
...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-md-6 col-md-offset-3">
      ...
      <form id="form" class="form-horizontal" role="form" method="get" action="<?php echo site_url("admin/addCustomer"); ?>">
        ...
        <div class="form-group">
          ...
          <button class="btn btn-default" type="button" onclick="window.location.href='<?php echo site_url("admin/customers"); ?>'">Cancel</button>
        </div>
      </form>
