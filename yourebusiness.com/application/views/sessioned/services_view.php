...
<div class="container">
  <button type="button" onclick="window.location.href='<?php echo site_url("admin/addService_view"); ?>'" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Add</button>
  <br><br>
      ...
      <tbody id="services">
        <script type="text/template" id="services-template">
          <tr>
            ...
            <td>{{memberPrice}}</td>
            <td>
              <button type="button" class="btn btn-warning btn-xs" onclick="window.location.href='<?php echo site_url("admin/editService_view"); ?>' + '?id=' + {{id}} ">&nbsp; Edit &nbsp; </button>
