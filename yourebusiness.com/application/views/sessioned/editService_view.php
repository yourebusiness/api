...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-4">
      ...
      <p>Edit the service details below.</p>

      <form id="editServiceDetails" action="<?php echo site_url('admin/editService') . '/' . $serviceDetails[0]['id']; ?>" method="get">
        <div class="form-group">
          <input value="<?php echo $serviceDetails[0]['serviceName']; ?>" type="text" class="form-control" id="serviceName" name="serviceName" placeholder="Service name" maxlength="120">
        </div>
        <div class="form-group">
          <textarea rows="4" class="form-control" id="description" name="description" placeholder="Service Description" maxlength="500" style="resize: none"><?php echo $serviceDetails[0]['description']; ?></textarea>
        </div>
        <div class="form-group">
          <input value="<?php echo $serviceDetails[0]['regPrice']; ?>" type="text" class="form-control" id="regPrice" name="regPrice" placeholder="Reg. Price" maxlength="10">
        </div>
        <div class="form-group">
          <input value="<?php echo $serviceDetails[0]['memberPrice']; ?>" type="text" class="form-control" id="memberPrice" name="memberPrice" placeholder="Member Price" maxlength="10">
        </div>

        <button id="edit-service" type="button" class="btn btn-primary">Submit</button>
        <button id="cancel" type="button" class="btn btn-default" onclick="window.location.href='<?php echo site_url("admin/services"); ?>'">Cancel</button>
      </form>
    </div>
