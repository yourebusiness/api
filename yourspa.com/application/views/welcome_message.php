            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?php echo base_url("api/signIn") ?>" method="post" class="form-horizontal">
        ...
        <nav class="navbar navbar-default">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a href="<?php base_url("welcome"); ?>" class="navbar-brand"><img src="../../../images/spa_logo.png" alt="Go to Home page"></a>
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="<?php echo base_url('aboutus/view'); ?>"><span class="glyphicon glyphicon-grain"></span> About Us</a></li>
                    </ul>
                </div> <!-- end of col-sm-2 -->
                <div class="col-sm-8">
                    <!-- some texts here -->
