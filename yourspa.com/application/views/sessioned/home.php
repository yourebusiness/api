    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            <li class="dropdown-submenu">
              <a tabindex="-1" href="#"><span class="glyphicon glyphicon-usd"></span> Transactions </a>
                <ul class="dropdown-menu">
                  <li><!-- <a tabindex="-1" href="#"></a> --></li>
                  <li><a href="<?php echo base_url("admin/transactions"); ?>"><span class="glyphicon glyphicon-plus-sign"></span> Add new Transaction</a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="<?php echo base_url('admin/profile') ?>"><span class="glyphicon glyphicon-user"></span> Profile</a></li>
