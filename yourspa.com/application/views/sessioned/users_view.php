...
<div class="container">
  <button type="button" onclick="window.location.href='<?php echo base_url("admin/usersadd_view"); ?>'" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Add</button>
  <br><br>
    ...
    <table class="table table-bordered table-hover">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a class="changeStatus" href="<?php echo base_url("admin/usersChangeStatus") . "/" . $row["userId"] . "/" . $row["active"] ; ?>"><?php echo $row["active"]; ?></a></td>
          <td>
              <?php
                if ($userRights == 0) {
          ...
          <td>
            <?php
              if ($userRights == 0)
            ?>  <a href="<?php echo base_url("admin/usersEdit") . "/" . $row["userId"]; ?>" class="editRecord"><span class="glyphicon glyphicon-edit"></span> Edit </a>
          &nbsp;
            <?php
              if ($row["trans"] == 'N')
            ?>  <a href="<?php echo base_url("admin/usersDelete") . "/" . $row["userId"]; ?>" class="deleteRecord"><span class="glyphicon glyphicon-trash"></span> Delete </a>
          </td>
        </tr>
        <?php }  /* for the foreach() */ ?>
      </tbody>
