$(function() {
    ...
    /*var user = namespace("yourSpa.Users");
    ...
    var getAllUsersExceptCurrent = function(data, status) {
        yourSpa.Users.Model = data;
    }

    $.get(url, getAllUsersExceptCurrent);

    console.log(typeof yourSpa.Users.Model);*/
});

YUI().use("datatable-mutable", "datatable-sort", "datatable-message", "panel", "io", function (Y) {
        ...
        columns: [
            {
                ...
                label: "User Id",
                allowHTML: true,
                formatter: '<a href="#" onclick="window.yourSpa.Users.Logic.showAlert({value})" data-toggle="modal" data-target="#addUser_modal">{value}</a>',
            },
            {
                key: "username",
                label: "Username"
