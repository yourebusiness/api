...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-1 col-md-offset-1">
      <button type="button" onclick="window.location.href='<?php echo site_url("admin/addCustomer_view"); ?>'" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Add</button>
    </div>
      ...
      <tbody id="customers">
        <script type="text/javascript" id="customers-template">
          <tr>
            ...
            <td>{{active}}</td>
            <td>
              <button type="button" class="btn btn-warning btn-xs" onclick="window.location.href='<?php echo site_url("admin/editCustomer_view"); ?>' + '?id=' + {{customerId}} ">&nbsp; Edit &nbsp; </button>
