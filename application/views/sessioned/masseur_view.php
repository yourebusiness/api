...
<div class="container">
  <button type="button" onclick="window.location.href='<?php echo site_url("admin/masseuradd_view"); ?>'" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Add</button>
  <br><br>
    ...
    <table class="table table-bordered table-hover">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a class="masseurchangestatus" href="<?php echo site_url("admin/masseurchangestatus") . "/" . $row["employeeId"] . "/" . $row["active"]; ?>"><?php echo $row["active"]; ?></a></td>
          <td>
            <?php
              if ($row["trans"] == 'N')
            ?>  <a href="<?php echo site_url("admin/masseurDelete") . "/" . $row["employeeId"]; ?>" class="deleteRecord"><span class="glyphicon glyphicon-trash"></span> Delete </a>
          </td>
        </tr>
        <?php } ?>
      </tbody>
